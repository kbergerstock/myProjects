...
void cSQUARES::insert(char* sz, SQUARE_NAMES sq )
{
   name_list.push_back(string(sz) ); 
...
//  return the string represening the square name
//  this should alwas work because of the enumeration control
//  throw an exceprion on failure
string& cSQUARES::search(SQUARE_NAMES square)
{
    return name_list[square];
}
